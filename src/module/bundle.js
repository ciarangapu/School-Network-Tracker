class AttendanceSystem {
    constructor() {
        ...
        this.EMAIL_REGEX = /^[a-z]+(@gmail\.com|[0-9]+@gmail\.com)$/; // Updated to allow name@gmail.com or name123@gmail.com
    ...
    restrictDashboardAccess() {
        ...
        } else if (currentPage === 'dashboard.html' && (!currentUser.id || currentUser.role !== 'admin')) {
    ...
    handleStudentLogin() {
        ...
        loginForm.addEventListener('submit', (e) => {
            ...
            const users = JSON.parse(localStorage.getItem('users') || '[]');
            const user = users.find(u => u.name.toLowerCase() === name.toLowerCase() && u.mac.toLowerCase() === mac.toLowerCase() && u.role === 'student');
